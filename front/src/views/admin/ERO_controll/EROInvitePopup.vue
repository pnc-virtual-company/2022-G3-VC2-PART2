        ...
        <card-components >
            <div class="bg-white">
                ...
                <div class="flex bg-white mt-4">
                    <div class="w-full bg-white font-medium">
                        <div :class="{'border-gray-300': !isEmailNull, 'border-red-500': isEmailNull}" class="flex bg-white mt-1 border-b-2 ">
                            ...
                            <input v-model="email" @input="checkValidate" type="email" required id="website-admin" placeholder="Email" class="text-[1.2rem] rounded-none pl-3 bg-white font-normal text-base  block flex-1 min-w-0 w-full p-2 rounded-r-md outline-none" >
                        </div>
                ...
                <div class="bg-white flex justify-end mt-4">
                    ...
                    <button-components @click="InviteERO" class="ml-3 bg-sky font-medium text-[1rem] text-white hover:bg-sky-hover">
                        Invite
                    </button-components>
                </div>
            </div>
