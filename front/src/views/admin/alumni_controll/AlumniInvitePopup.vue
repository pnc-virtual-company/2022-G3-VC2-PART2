        ...
        <card-components >
            <form class="bg-white">
                ...
                <div class="flex bg-white mt-4">
                    <div class="w-full   bg-white font-medium">
                        <div class="flex bg-white mt-1">
                            ...
                            <input v-model ="email" type="text" id="website-admin" placeholder="email" class="text-[1.2rem] rounded-none pl-3 bg-white font-normal text-base  block flex-1 min-w-0 w-full border-gray-300 border-b-2 p-2 rounded-r-md outline-none" >
                        </div>
                    </div>
                </div>
                <div class="bg-white flex justify-end mt-4">
                    ...
                    <button-components  class="ml-3 bg-sky font-medium text-white text-[1rem] hover:bg-sky-hover" @click="InviteERO">
                        Invite
                    </button-components>
                </div>
            </form>
