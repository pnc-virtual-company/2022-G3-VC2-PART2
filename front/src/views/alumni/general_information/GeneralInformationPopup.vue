            ...
            <form @input="upDateValidation" class="bg-white">
                ...
                <div class="flex bg-white mt-4">
                    ...
                    <div class="w-2/4 bg-white font-medium ml-2">
                        ...
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isLastName}">
                                <svg class="w-[28px] h-[28px] text-white bg-sky rounded-full p-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"></path></svg>
                            </span>
                            <input type="text" v-model="lastName" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full border-gray-300 border-2 p-2 rounded-r-md" :class="{'border-red-400':isLastName}" placeholder="Last Name">
                        </div>
                    </div>
                </div>
                <div class="flex bg-white mt-3">
                    <div class="w-2/4 bg-white font-medium mr-2">
                        ...
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isEmail}">
                            ...
                            <input v-model="email" type="email" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full border-gray-300 border-2 p-2 rounded-r-md" :class="{'border-red-400':isEmail}" placeholder="Email">
                        </div>
                    </div>
                    <div class="w-2/4 bg-white font-medium ml-2">
                        <span class="bg-white">Batch:</span>
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isBatch}">
                            ...
                            <input type="text" v-model="batch" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full border-gray-300 border-2 p-2 rounded-r-md" :class="{'border-red-400':isBatch}" placeholder="Batch">
                        </div>
                    </div>
                </div>
                <div class="flex bg-white mt-3">
                    <div class="w-2/4 bg-white font-medium mr-2">
                        ...
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm   rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isPhone}">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[26px] h-[26px] text-white bg-sky rounded-full p-1">
                                <path fill-rule="evenodd" d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z" clip-rule="evenodd" />
                            </svg>
                            </span>
                            <input type="text" v-model="phone" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full border-gray-300 border-2 p-2 rounded-r-md" :class="{'border-red-400':isPhone}" placeholder="Phone">
                        </div>
                    </div>
                    <div class="w-2/4 bg-white font-medium ml-2">
                        <span class="bg-white">Telegram:</span>
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isTelegram}">
                                <img class="w-[26px] h-[26px]"  src="../../../assets/telegram.jpg" alt="">
                            </span>
                            <input type="text" v-model="telegram" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full  border-gray-300 border-2 p-2 rounded-r-md" :class="{'border-red-400':isTelegram}" placeholder="Telegram">
                        </div>
                    </div>
                </div>
                <div class="flex mt-3">
                    <div class="w-2/4 bg-white font-medium mr-2">
                        ...
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isMajor}">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[26px] h-[26px] text-white bg-sky rounded-full p-1">
                            ...
                            <input v-model="major" type="text" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full  border-gray-300 border-2 p-2 rounded-r-md" :class="{'border-red-400':isMajor}" placeholder="Major">
                        </div>
                    </div>
                    <div class="w-2/4 bg-white font-medium ml-2">
                        <span class="bg-white">Address:</span>
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isAddress}">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[26px] h-[26px] text-white bg-sky rounded-full p-1">
                                    <path fill-rule="evenodd" d="M11.54 22.351l.07.04.028.016a.76.76 0 00.723 0l.028-.015.071-.041a16.975 16.975 0 001.144-.742 19.58 19.58 0 002.683-2.282c1.944-1.99 3.963-4.98 3.963-8.827a8.25 8.25 0 00-16.5 0c0 3.846 2.02 6.837 3.963 8.827a19.58 19.58 0 002.682 2.282 16.975 16.975 0 001.145.742zM12 13.5a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" />
                                </svg>
                            </span>
                            <input v-model="address" type="text" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full  border-gray-300 border-2 p-2 rounded-r-md" :class="{'border-red-400':isAddress}" placeholder="Address">
                        </div>
                    </div>
                </div>
                <div class="flex bg-white mt-3">
                    <div class="w-2/4 bg-white font-medium mr-2">
                        ...
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isGender}">
                                <img class="w-[26px] h-[26px]"  src="../../../assets/gender.jpg" alt="">
                            </span>
                            <select v-model="gender" id="" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full  border-gray-300 border-2 p-2 rounded-r-md" :class="{'border-red-400':isGender}">
                    ...
                    <div class="w-2/4 bg-white font-medium ml-2">
                        ...
                        <div class="flex bg-white mt-1">
                            <span class="bg-white inline-flex items-center p-2 text-sm rounded-l-md border-2 border-r-0 border-gray-300" :class="{'border-red-400':isBirthDate}">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[26px] h-[26px] text-white bg-sky rounded-full p-1">
                            ...
                            <input type="date" v-model="birthDate" :class="{'border-red-400':isBirthDate}" class="rounded-none outline-sky bg-white font-normal text-base  block flex-1 min-w-0 w-full  border-gray-300 border-2 p-2 rounded-r-md">
                        </div>
                    </div>
                </div>
