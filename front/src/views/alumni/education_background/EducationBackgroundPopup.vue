        ...
        <card-components>
            <form  class="bg-white"  @input="checkValidation" >
                ...
                <div class="w-full bg-white font-medium">
                    <div class="w-full bg-white font-medium">
                        ...
                        <div class="flex bg-white mt-1">
                            ...
                            <div :class="{ 'border-red-400': isSchoolNull, 'border-gray-300': !isSchoolNull && !isFocusSchool, 'border-sky rounded-l-md':isFocusSchool }" class="w-full flex items-center border-2 rounded-r-md">
                                <div v-if="schoolId" class="flex justify-end items-center ml-3 bg-[#e2e2e2] h-[75%] rounded-2xl px-3">
                    ...
                    <div v-if="isShowSchools" class="absolute min-w-[22rem] max-h-[12rem] ml-11 overflow-y-auto scroll-box border-l-[1px] border-r-[1px] border-b-[1px] bg-white border-sky rounded-none cursor-pointer font-normal text-base block flex-1">
