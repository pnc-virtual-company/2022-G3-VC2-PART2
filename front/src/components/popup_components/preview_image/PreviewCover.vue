<template>
   <popup-component>
        <card-components class="w-4/12">
            <div>
                <div>
                    <h2 class="mb-5 m-auto text-center font-bold text-3xl">Update your cover image</h2>
                    <img v-if="!showNewImage" class=" m-auto h-[200px] w-[200px] rounded-full" :src="urlCover" alt="">
                    <img v-else class=" m-auto h-[200px] w-[200px] rounded-full" :src="coverImage" alt="">
...
<script>
    ...
    export default {
      ...
      methods: {
        hidePopup() {
            this.userInfor.showEditCover = false;
            this.hideWarning()
