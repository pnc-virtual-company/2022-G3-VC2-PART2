        ...
        <card-components class="w-4/12">
            <div>
                <div>
                    ...
                    <img v-if="!showNewImage" class="object-cover object-center m-auto h-[200px] w-[200px] rounded-full" :src="urlProfile" alt="">
                    <img v-else class="object-cover object-center m-auto h-[200px] w-[200px] rounded-full" :src="profileImage" alt="">
                    <div class="flex justify-center item-center w-full relative  bg-white">
                        <div class="shadow-sm shadow-[black] h-8 w-8 rounded-full bg-white mt-[-20px] flex justify-center items-center">
                            <input id="upload_img"  name="upload_img" @change="onFileChange" type="file" class="hidden">
                            <label for="upload_img" class="hover:bg-gray-300 h-full flex justify-center items-center rounded-full cursor-pointer">
