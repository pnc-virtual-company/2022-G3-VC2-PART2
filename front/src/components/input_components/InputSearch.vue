<template>
    <div>
        ...
        <div class="relative w-full">
            ...
            <input type="text" v-model="keyword" @input="$emit('search-keyword', keyword)" id="search" class="bg-white border focus:outline-gray-300 border-gray-300  text-lg rounded-lg w-full pl-10 p-[10px]" placeholder="Search" required>
        </div>
    </div>
</template>
