<template>
    ...
    <div class="relative w-full">
        ...
        <input type="text" id="search" class="bg-white border focus:outline-gray-300 border-gray-300  text-lg rounded-lg w-full pl-10 p-[10px]" placeholder="Search" required>
    </div>
</template>