    ...
    <div>
        <div>
            ...
            <div class="flex justify-end item-center w-full relative -top-[0.30rem] bg-red-700">
                <div @click="$emit('click-cover')" class="h-8 mr-2 w-8 rounded-full shadow-sm shadow-[black] bg-white mt-[-35px] ml-[4.8rem] flex justify-end items-center hover:bg-gray-300">
