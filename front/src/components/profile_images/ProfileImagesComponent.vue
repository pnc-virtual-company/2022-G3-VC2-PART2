        ...
        <div class="flex justify-between mt-[-6rem] ml-[33px]">
            <div class="flex flex-col items-center">
                <div>
                    ...
                    <div @click="userInfor.showEditCover=!userInfor.showEditCover" class="shadow-sm shadow-[black] h-8 w-8 rounded-full bg-white mt-[-35px] absolute ml-[6rem] hover:bg-gray-300 flex justify-center items-center">
...
<script>
    ...
    export default {
      ...
      computed:{
        urlProfile(){
            if(this.userInfor.userData.profile.substring(0,4) == "IMG_"){
        ...
        urlCover(){
            if(this.userInfor.userData.cover.substring(0,4) == "IMG_"){
