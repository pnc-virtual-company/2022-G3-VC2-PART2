<template>
    <div class="shadow shadow-gray-400 bg-white p-[10px] mt-5 rounded-md flex justify-between items-center ">
        ...
        <div class="w-[10%] items-center ml-[50px]">
            ...
            <button @click="$emit('delete-item')" class="ml-1 hover:bg-[#e6e6ec] rounded-full p-2 flex justify-center items-center">
