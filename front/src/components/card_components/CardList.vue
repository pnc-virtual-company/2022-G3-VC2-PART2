<template>
    <div class="shadow shadow-gray-400 bg-white p-[10px] mt-5 rounded-md flex">
        ...
        <div class="w-[12%] text-center">
            ...
            <div class="flex justify-center items-center">
                ...
                <button class="ml-2 hover:bg-[#e6e6ec] rounded-full p-2 flex justify-center items-center" @click="$emit('delete-item')">
