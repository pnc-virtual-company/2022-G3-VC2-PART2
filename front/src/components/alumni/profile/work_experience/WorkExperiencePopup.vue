                ...
                <div class="flex bg-white mt-4">
                    <div class="w-full bg-white font-medium">
                        ...
                        <div class="flex bg-white mt-1">
                            ...
                            <select id="" class="rounded-none bg-white cursor-pointer font-normal text-base  block flex-1 min-w-0 w-full text-sm border-gray-300 border-2 p-2 rounded-r-md">
                ...
                <div class="flex bg-white mt-4">
                    <div class="w-full bg-white font-medium">
                        ...
                        <div class="flex bg-white mt-1">
                            ...
                            <input type="text" id="website-admin" placeholder="position" class="rounded-none pl-3 bg-white font-normal text-base  block flex-1 min-w-0 w-full text-sm border-gray-300 border-2 p-2 rounded-r-md" >
                        </div>
                    </div>
                </div>
                <div class="flex bg-white mt-4">
                    <div class="w-2/4 bg-white font-medium mr-2">
                        ...
                        <div class="flex bg-white mt-1">
                            ...
                            <input type="date" id="website-admin" class="rounded-none bg-white font-normal text-base  block flex-1 min-w-0 w-full text-sm border-gray-300 border-2 p-2 rounded-r-md" placeholder="email">
                        </div>
                    </div>
                    <div class="w-2/4 bg-white font-medium ml-2">
                        ...
                        <div class="flex bg-white mt-1">
                            ...
                            <input type="date" id="website-admin" class="rounded-none bg-white font-normal text-base  block flex-1 min-w-0 w-full text-sm border-gray-300 border-2 p-2 rounded-r-md" >
                        </div>
                    </div>
                </div>
