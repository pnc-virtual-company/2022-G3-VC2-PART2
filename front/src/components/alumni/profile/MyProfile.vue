                ...
                <div class="flex flex-col items-center">
                    <div>
                        ...
                        <div class="h-8 w-8 rounded-full bg-white mt-[-35px] absolute ml-[4.8rem] flex justify-center items-center">
                            ...
                            <label for="upload_img" class="w-full shadow h-full flex justify-center items-center rounded-full bg-white">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[80%] bg-white rounded-lg text-black">
            ...
            <div class="">
                <div class="bg-white flex">
                    <div class="flex items-center mt-3 w-8/12 bg-white">
                        ...
                        <h1 class="ml-2 text-[20px] bg-white">Phearun@gmail.com</h1>
                    </div>
                    <div class="flex items-center bg-white mt-3 w-/12">
                        ...
                        <h1 class="ml-2 text-[20px] bg-white">2022</h1>
                    </div>
                </div>
                <div class="bg-white flex">
                    <div class="flex items-center mt-3 w-8/12 bg-white">
