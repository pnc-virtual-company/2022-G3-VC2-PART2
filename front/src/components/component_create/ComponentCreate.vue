    ...
    <popup-component>
        <card-components class="w-[40%]">
            <form class="bg-white" @input="checkForm">
                <h1 class="text-center font-bold text-2xl bg-white">Add Company</h1>
                <div class="w-24 h-24 m-auto mt-3 flex justify-center items-end">
                    <img src="./../../assets/logo.png" class="w-full h-full rounded-full">
                ...
                <div class="bg-white mt-3">
                    <div class="w-full bg-white font-medium">
                        ...
                        <div class="flex bg-white mt-1">
                            <span :class="{'border-red-400': isNameNull}" class="bg-white inline-flex items-center p-2 rounded-l-md border-2 border-r-0 border-gray-300">
                            ...
                            <input v-model="name" type="text" placeholder="Name" :class="{'border-red-400': isNameNull}" class="rounded-none pl-3 bg-white font-normal text-base  block flex-1 min-w-0 w-full border-gray-300 border-2 p-2 rounded-r-md  outline-sky">
                        </div>
                    </div>
                </div>
                <div class="bg-white mt-3">
                    <div class="w-full bg-white font-medium">
                        ...
                        <div class="flex bg-white mt-1">
                            <span :class="{'border-red-400': isAddressNull}" class="bg-white inline-flex items-center p-2 rounded-l-md border-2 border-r-0 border-gray-300">
                            ...
                            <input v-model="address" type="text" placeholder="Address" :class="{'border-red-400': isAddressNull}" class="rounded-none pl-3 bg-white font-normal text-base  block flex-1 min-w-0 w-full border-gray-300 border-2 p-2 rounded-r-md  outline-sky">
                        </div>
                    </div>
                </div>
                ...
                <alert-missing v-if="errorMessage">
                    {{ errorMessage }}
                </alert-missing>
                <div class="bg-white flex justify-end mt-4">
                    ...
                    <button-components @click="createCompany" class="ml-3 bg-sky font-medium text-white hover:bg-sky-hover">
                        Add
                    </button-components>
                </div>
            </form>
        ...
        methods: {
            createCompany(){
                if(this.isValidated()){
                    ...
                    this.$emit('create-object', object);
